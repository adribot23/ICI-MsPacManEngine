...
public class MsPacManStorageManager {
	...
	// Si aumentamos TIME_WINDOW se almacenaran mas casos pero se perdera su
	// CaseBase asociado por lo que se guardaran en csv distintos y seria errorneo
	// (solucionado con hashMap)
	...
	public MsPacManStorageManager() {
		// this.buffer = new Vector<Pair<CBRCase,CBRCASEBASe>(); el profe nos ha dicho
		// esto
